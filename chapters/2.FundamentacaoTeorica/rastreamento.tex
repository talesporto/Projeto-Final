...
\subsection{Representação do Objeto}
	...
	\begin{itemize}
		...
		\item \textbf{Formas geométricas primitivas:} o objeto é representado por formas geométricas simples omo um retângulo ou uma elipse, como mostrados nas Figuras \ref{representacao}(c) e (d)~\cite{comaniciu}. Essa representação é mais adequada para simples objetos rígidos~\cite{yilmaz};
