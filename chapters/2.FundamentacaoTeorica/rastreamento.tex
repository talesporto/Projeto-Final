...
% 	Tracking from a single view includes two major components: preprocessing and feature correspondence between consecutive \textit{frame}s. Three stages of preprocessing are performed:
