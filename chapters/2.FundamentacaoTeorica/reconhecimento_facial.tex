...
Na teoria, esse método extrai as informações relevantes de uma face, codifica-a da maneira mais eficiente possível, e a compara com um banco de faces codificadas de maneira similar. Uma maneira simples de extrair as informações relevantes contidas em uma imagem de uma face é, de alguma maneira, captar a variação em uma coleção de imagens de face e usar essa informação para codificar e comparar imagens individuais de faces~\cite{turk}. 
