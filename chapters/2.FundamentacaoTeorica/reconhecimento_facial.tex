...
O processo de detecção de faces geralmente é dificultado por três principais razões mostradas a seguir:
	...
	\begin{enumerate}
		\item Embora a maioria das faces apresente estruturas semelhantes (olhos, bocas, nariz, entre outros) e são dispostas aproximadamente na mesma configuração de espaço, pode haver um grande número de componentes não rigídos e texturas diferentes entre as faces. Um exemplo são as flexibilizações causadas pelas expressões faciais \cite{oliveira};
