...
\label{ref:viola-jones}
	...
	por usa vez.  Os algoritmos \textit{AdaBoost} são utilizados em conjunto com os
	classificadores fracos para que, com o tempo, se tornem mais fortes. E por fim
	os classificadoes em cascatas definem a detecção, ou não, de uma face na
	figura.
