...
\label{sec:biometria}
	...
	\begin{table}[h]
		\begin{center}
			\caption{Requisitos teóricos para sistemas biométricos \cite{milene}.}
			\label{tab:tabelaRequisitosTeoricos}
			\begin{tabular}{|c|c|c|c|c|}
				\hline \bf Biometria & \bf Universalidade & \bf Singularidade & \bf Permanência & \bf Exigibilidade \\
	...
	\begin{table}[h]
		\begin{center}
			\caption{Requisitos práticos para sistemas biométricos \cite{milene}.}
