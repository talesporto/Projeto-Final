...
Os sensores utilizados e as condições do \textit{SmartSpace} deste projeto são descritos pela Figura \ref{upc}. Os seguintes sensores foram utilizados~\cite{salah}:
	...
	\begin{itemize}
		\item quatro camêras nos cantos da sala (rotuladas como Cam1 a Cam4 na Figura \ref{upc});
...
As camêras no sistema são responsáveis pela detecção de movimento, rastreamento, detecção e reconhecimento facial que são as funcionalidades que nos interessam.
