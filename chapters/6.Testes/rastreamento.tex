\section{Rastreamento dos Usuários}
	...
	\begin{figure}[htb]
		\begin{center}
				\subfloat[] {
					\includegraphics[width=0.23\textwidth]{figuras/5.Testes/deteccao/1.png}}
				\subfloat[] {
					\includegraphics[width=0.23\textwidth]{figuras/5.Testes/deteccao/2.png}}
				\subfloat[] {
					\includegraphics[width=0.23\textwidth]{figuras/5.Testes/deteccao/3.png}}
				\subfloat[] {
					\includegraphics[width=0.23\textwidth]{figuras/5.Testes/deteccao/4.png}}
		\end{center}
...
% 	cujos testes mostraram que tem alcance máximo de 4,057 metros
