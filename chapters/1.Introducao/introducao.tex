...
É proposta então uma solução para o problema de localização e identificação de perfis de usuários em um \textit{SmartSpace} utilizando como base o middleware \textit{UbiquitOS} \cite{alegomes} integrado com o \textit{Kinect}.
